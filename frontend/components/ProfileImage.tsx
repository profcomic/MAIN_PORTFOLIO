    ...
    >
      <div className="relative w-48 h-48 md:w-64 md:h-64">
        ...
        <motion.div
          ...
          className="relative w-full h-full rounded-full overflow-hidden border-4 border-violet-500 shadow-[0_0_50px_rgba(139,92,246,.35)]"
        >
          <Image
        ...
        {[...Array(3)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-violet-400 rounded-full shadow-[0_0_10px_rgba(167,139,250,.8)]"
